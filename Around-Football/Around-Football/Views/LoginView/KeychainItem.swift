...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.changhyun-kyle.Around-Football", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.changhyun-kyle.Around-Football", account: "userIdentifier").deleteItem()
        } catch {
